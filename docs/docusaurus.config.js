...
const BASE_URL = '/docs/ruth/';
const SITE_URL = 'https://rasa.com';
// NOTE: this allows switching between local dev instances of ruth/ruth-x
...
module.exports = {
  customFields: {
    ...
    productLogo: '/img/logo-ruth-oss.png',
    versionLabels,
    legacyVersions: [{
      label: 'Legacy 1.x',
  ...
  themeConfig: {
    announcementBar: {
      ...
      content: 'These docs are for version 2.0 of Rasa Open Source. <a href="https://legacy-docs-v1.ruth.com/">Docs for the 1.x series can be found here.</a>',
