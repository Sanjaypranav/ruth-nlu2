...
import ruth.core.training.story_conflict
...
class Validator:
    ...
    def verify_example_repetition_in_intents(
        ...
        for example in self.intents.intent_examples:
            text = example.get(ruth.shared.nlu.constants.TEXT)
    ...
    def _gather_utterance_actions(self) -> Set[Text]:
        ...
        """
        domain_responses = {
            response.split(ruth.shared.nlu.constants.RESPONSE_IDENTIFIER_DELIMITER)[0]
    ...
    def verify_story_structure(
        ...
        conflicts = ruth.core.training.story_conflict.find_story_conflicts(
