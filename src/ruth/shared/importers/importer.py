...
from ruth.shared.core.events import ActionExecuted, UserUttered
...
from ruth.shared.nlu.constants import ENTITIES, ACTION_NAME
from ruth.shared.importers.autoconfig import TrainingType
from ruth.shared.core.domain import IS_RETRIEVAL_INTENT_KEY
...
class TrainingDataImporter:
    ...
    def load_from_config(
        ...
        config = ruth.shared.utils.io.read_config_file(config_path)
    ...
    def _importer_from_dict(
        ...
        from ruth.shared.importers.multi_project import MultiProjectImporter
        from ruth.shared.importers.rasa import RasaFileImporter
        ...
        if module_path == RasaFileImporter.__name__:
            ...
            try:
                importer_class = ruth.shared.utils.common.class_from_module_path(
                    module_path
                )
        ...
        constructor_arguments = ruth.shared.utils.common.minimal_kwargs(
...
class CombinedDataImporter(TrainingDataImporter):
    ...
    @ruth.shared.utils.common.cached_method
    async def get_config(self) -> Dict:
        """Retrieves model config (see parent class for full docstring)."""
...
class ResponsesSyncImporter(TrainingDataImporter):
    ...
    def _construct_retrieval_action_names(retrieval_intents: Set[Text]) -> List[Text]:
        ...
        """
        return [
            f"{ruth.shared.constants.UTTER_PREFIX}{intent}"
...
def _additional_training_data_from_default_actions() -> TrainingData:
    additional_messages_from_default_actions = [
        ...
        for action_name in ruth.shared.core.constants.DEFAULT_ACTION_NAMES
    ]
