...
from ruth.shared.constants import DOCS_URL_MIGRATION_GUIDE_MD_DEPRECATION
from ruth.shared.exceptions import MarkdownException
...
from ruth.shared.nlu.training_data.util import encode_string, decode_string
...
class MarkdownReader(TrainingDataReader):
    ...
    def is_markdown_nlu_file(filename: Union[Text, Path]) -> bool:
        content = ruth.shared.utils.io.read_file(filename)
