...
def validate_yaml_schema(yaml_file_content: Text, schema_path: Text) -> None:
    ...
    try:
        ...
        # right line
        source_data = ruth.shared.utils.io.read_yaml(
    ...
    schema_content = ruth.shared.utils.io.read_yaml_file(schema_file)
    schema_utils_content = ruth.shared.utils.io.read_yaml_file(schema_utils_file)
...
def validate_training_data(json_data: Dict[Text, Any], schema: Dict[Text, Any]) -> None:
    """Validate ruth training data format to ensure proper training.
