...
from ruth.shared.core.constants import SHOULD_NOT_BE_SET
...
from ruth.shared.core.trackers import DialogueStateTracker, FrozenState
...
class TrackerWithCachedStates(DialogueStateTracker):
    ...
    def past_states_for_hashing(
        ...
        Args:
            domain: a :class:`ruth.shared.core.domain.Domain`
