...
from ruth.shared.constants import DOCS_URL_SLOTS
...
class Slot:
    ...
    def resolve_by_type(type_name: Text) -> Type["Slot"]:
        ...
        for cls in ruth.shared.utils.common.all_subclasses(Slot):
            if cls.type_name == type_name:
                return cls
        try:
            return ruth.shared.utils.common.class_from_module_path(type_name)
    ...
    def persistence_info(self) -> Dict[str, Any]:
        return {
            "type": ruth.shared.utils.common.module_path_from_instance(self),
...
class CategoricalSlot(Slot):
    ...
    def add_default_value(self) -> None:
        ...
        if ruth.shared.core.constants.DEFAULT_CATEGORICAL_SLOT_VALUE not in values:
            self.values.append(
                ruth.shared.core.constants.DEFAULT_CATEGORICAL_SLOT_VALUE
            )
    ...
    def persistence_info(self) -> Dict[Text, Any]:
        ...
        d["values"] = [
            ...
            if value != ruth.shared.core.constants.DEFAULT_CATEGORICAL_SLOT_VALUE
        ]
        return d
