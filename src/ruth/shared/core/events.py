...
from ruth.shared.constants import DOCS_URL_TRAINING_DATA
...
from ruth.shared.exceptions import UnsupportedFeatureException
...
class Event(ABC):
    ...
    user with the assistant. Tells the `ruth.shared.core.trackers.DialogueStateTracker`
    ...
    def resolve_by_type(
        ...
        for cls in ruth.shared.utils.common.all_subclasses(Event):
