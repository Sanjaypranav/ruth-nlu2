...
from ruth.shared.core.constants import ACTION_LISTEN_NAME
from ruth.shared.core.domain import Domain
from ruth.shared.core.events import UserUttered, ActionExecuted, Event
...
def persist_graph(graph: "networkx.Graph", output_file: Text) -> None:
    ...
    template = ruth.shared.utils.io.read_file(visualization_html_path())
    ...
    ruth.shared.utils.io.write_text_file(template, output_file)
