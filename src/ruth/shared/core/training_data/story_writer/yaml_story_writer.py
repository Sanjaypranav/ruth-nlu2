...
from ruth.shared.core.training_data.story_writer.story_writer import StoryWriter
...
class YAMLStoryWriter(StoryWriter):
    ...
    def process_user_utterance(
        ...
        if user_utterance.text and (
            ...
            result[KEY_USER_MESSAGE] = LiteralScalarString(
                ruth.shared.core.events.format_message(
                    user_utterance.text,
    ...
    def process_action(action: ActionExecuted) -> Optional[OrderedDict]:
        ...
        Returns:
            Dict with an action.
        """
        if action.action_name == ruth.shared.core.constants.RULE_SNIPPET_ACTION_NAME:
            return None
    ...
    def process_rule_step(self, rule_step: RuleStep) -> OrderedDict:
        ...
        if normal_events and not (
                ...
                == ruth.shared.core.constants.RULE_SNIPPET_ACTION_NAME
        ):
