...
from ruth.shared.constants import DOCS_URL_RULES
...
from ruth.core.policies.policy import SupportedData, PolicyPrediction
from ruth.shared.core.trackers import (
    DialogueStateTracker,
    get_active_loop_name,
    is_prev_action_listen_in_state,
)
from ruth.shared.core.generator import TrackerWithCachedStates
from ruth.core.constants import DEFAULT_CORE_FALLBACK_THRESHOLD, RULE_POLICY_PRIORITY
...
from ruth.shared.core.domain import InvalidDomain, State, Domain
...
class RulePolicy(MemoizationPolicy):
    ...
    def _check_for_incomplete_rules(
        ...
        rule_fingerprints = ruth.core.training.training.create_action_fingerprints(
    ...
    def _predicted_action_name(
        ...
        if (
            ...
            ruth.core.test.emulate_loop_rejection(tracker)
            predicted_action_name, prediction_source = self._predict_next_action(
                tracker, domain
            )
