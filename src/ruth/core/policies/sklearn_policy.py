...
import ruth.utils.tensorflow.model_data_utils as model_data_utils
...
from ruth.shared.nlu.constants import ACTION_TEXT, TEXT
from ruth.shared.nlu.training_data.features import Features
from ruth.utils.tensorflow.model_data import Data, FeatureArray
from ruth.utils.tensorflow.constants import SENTENCE
...
class SklearnPolicy(Policy):
    ...
    def persist(self, path: Union[Text, Path]) -> None:
        ...
        if self.model:
            ...
            ruth.shared.utils.io.dump_obj_as_json_to_file(meta_file, meta)

            filename = path / "sklearn_model.pkl"
            ruth.utils.io.pickle_dump(filename, self._state)
    ...
    def load(
        ...
        meta = json.loads(ruth.shared.utils.io.read_file(meta_file))
