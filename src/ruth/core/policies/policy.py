...
from ruth.shared.core.domain import Domain, State
...
from ruth.core.constants import DEFAULT_POLICY_PRIORITY
...
from ruth.shared.nlu.constants import ENTITIES, INTENT, TEXT, ACTION_TEXT, ACTION_NAME
...
class Policy:
    ...
    def _get_valid_params(func: Callable, **kwargs: Any) -> Dict:
        ...
        """
        valid_keys = ruth.shared.utils.common.arguments_of(func)
    ...
    def _featurize_for_training(
        ...
        **kwargs: Any,
        ...
        Args:
            training_trackers:
                the list of the :class:`ruth.core.trackers.DialogueStateTracker`
            domain: the :class:`ruth.shared.core.domain.Domain`
            interpreter: the :class:`ruth.core.interpreter.NaturalLanguageInterpreter`
    ...
    def persist(self, path: Union[Text, Path]) -> None:
        ...
        ruth.shared.utils.io.create_directory_for_file(file)
        ruth.shared.utils.io.dump_obj_as_json_to_file(file, self._metadata())
    ...
    def load(cls, path: Union[Text, Path], **kwargs: Any) -> "Policy":
        ...
        if metadata_file.is_file():
            data = json.loads(ruth.shared.utils.io.read_file(metadata_file))
            ...
            constructor_args = ruth.shared.utils.common.arguments_of(cls)
