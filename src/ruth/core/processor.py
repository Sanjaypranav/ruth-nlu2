...
from ruth.core import jobs
from ruth.core.actions.action import Action
...
from ruth.shared.core.slots import Slot
...
import ruth.shared.core.trackers
...
class MessageProcessor:
    def __init__(
        ...
        domain: Domain,
        tracker_store: ruth.core.tracker_store.TrackerStore,
    ...
    async def _update_tracker_session(
        ...
        if not tracker.applied_events() or self._has_session_expired(tracker):
            ...
            if isinstance(
                action_session_start, ruth.core.actions.action.ActionSessionStart
            ):
    ...
    def get_trackers_for_all_conversation_sessions(
        ...
        return ruth.shared.core.trackers.get_trackers_for_conversation_sessions(tracker)
    ...
    def predict_next_action(
    ...
    ) -> Tuple[ruth.core.actions.action.Action, PolicyPrediction]:
        ...
        action = ruth.core.actions.action.action_for_index(
    ...
    ) -> Optional[ruth.core.actions.action.Action]:
        return ruth.core.actions.action.action_for_name_or_text(
    ...
    async def _run_action(
        self,
        action: ruth.core.actions.action.Action,
        tracker: DialogueStateTracker,
        output_channel: OutputChannel,
        nlg: NaturalLanguageGenerator,
        prediction: PolicyPrediction,
        ...
        except ruth.core.actions.action.ActionExecutionRejection:
            events = [
                ActionExecutionRejected(
