...
from ruth.shared.constants import DOCS_BASE_URL, DEFAULT_SENDER_ID
from ruth.core.constants import BEARER_TOKEN_PREFIX
...
class UserMessage:
    ...
    def __init__(
        ...
        Args:
            ...
            parse_data: ruth data about the message.
