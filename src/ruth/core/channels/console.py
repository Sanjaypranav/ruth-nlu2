...
from ruth.cli import utils as cli_utils
from ruth.core import utils
from ruth.core.channels.rest import RestInput
from ruth.core.constants import DEFAULT_SERVER_URL
...
def print_buttons(
    ...
    color: Text = ruth.shared.utils.io.bcolors.OKBLUE,
    ...
    if is_latest_message:
        ...
        ruth.shared.utils.cli.print_color("Buttons:", color=color)
...
def print_bot_output(
    ...
    if "text" in message:
        ruth.shared.utils.cli.print_color(message.get("text"), color=color)

    if "image" in message:
        ruth.shared.utils.cli.print_color("Image: " + message.get("image"), color=color)
    ...
    if "elements" in message:
        ruth.shared.utils.cli.print_color("Elements:", color=color)
    ...
    if "quick_replies" in message:
        ruth.shared.utils.cli.print_color("Quick Replies:", color=color)
    ...
    if "custom" in message:
        ruth.shared.utils.cli.print_color("Custom json:", color=color)
        ruth.shared.utils.cli.print_color(
