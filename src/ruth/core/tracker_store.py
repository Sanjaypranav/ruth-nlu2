...
import ruth.core.utils as core_utils
...
from ruth.shared.core.events import SessionStarted
...
def _load_from_module_name_in_endpoint_config(
    ...
    try:
        tracker_store_class = ruth.shared.utils.common.class_from_module_path(
            store.type
        )
