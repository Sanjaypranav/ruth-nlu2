...
from ruth.constants import DEFAULT_SANIC_WORKERS, ENV_SANIC_WORKERS
from ruth.shared.constants import DEFAULT_ENDPOINTS_PATH

# backwards compatibility 1.0.x
# noinspection PyUnresolvedReferences
from ruth.core.lock_store import LockStore, RedisLockStore, InMemoryLockStore
from ruth.utils.endpoints import EndpointConfig, read_endpoint_config
from sanic import Sanic
from sanic.views import CompositionView
import ruth.cli.utils as cli_utils
...
def configure_file_logging(
    ...
    file_handler = logging.FileHandler(
        log_file, encoding=ruth.shared.utils.io.DEFAULT_ENCODING
    )
