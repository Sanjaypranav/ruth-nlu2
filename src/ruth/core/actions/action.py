...
from ruth.shared.nlu.constants import INTENT_NAME_KEY, INTENT_RANKING_KEY
...
from ruth.utils.endpoints import EndpointConfig, ClientResponseError
...
if TYPE_CHECKING:
    ...
    from ruth.shared.core.events import IntentPrediction
...
def default_actions(action_endpoint: Optional[EndpointConfig] = None) -> List["Action"]:
    ...
    from ruth.core.actions.two_stage_fallback import TwoStageFallbackAction
...
def action_for_name_or_text(
    ...
    if is_form and not user_overrode_form_action:
        from ruth.core.actions.forms import FormAction
...
class Action:
    ...
    async def run(
        ...
        Returns:
            A list of :class:`ruth.core.events.Event` instances
        """
        raise NotImplementedError
...
class RemoteAction(Action):
    ...
    def _action_call_format(
        ...
        from ruth.shared.core.trackers import EventVerbosity
        ...
        for response in responses:
            ...
            if generated_template and not generated_response:
                ...
                ruth.shared.utils.io.raise_deprecation_warning(
                    ...
                    docs=f"{ruth.shared.constants.DOCS_BASE_URL_ACTION_SERVER}"
                    f"/sdk-dispatcher",
                )
...
class ActionRevertFallbackEvents(Action):
    ...
    async def run(
        ...
        """Runs action. Please see parent class for the full docstring."""
        from ruth.core.policies.two_stage_fallback import has_user_rephrased
