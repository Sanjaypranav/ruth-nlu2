...
from ruth.nlu.utils import bilou_utils
from ruth.nlu.utils.bilou_utils import BILOU_PREFIXES
from ruth.shared.core.domain import SubState, State, Domain
from ruth.shared.nlu.interpreter import NaturalLanguageInterpreter, RegexInterpreter
from ruth.shared.core.constants import PREVIOUS_ACTION, ACTIVE_LOOP, USER, SLOTS
from ruth.shared.constants import DOCS_URL_MIGRATION_GUIDE
from ruth.shared.core.trackers import is_prev_action_listen_in_state
...
class SingleStateFeaturizer:
    ...
    featurized into a list of `ruth.utils.features.Features`.
    """

    def __init__(self) -> None:
        """Initialize the single state featurizer."""
        # ruth core can be trained separately, therefore interpreter during training
        # will be `RegexInterpreter`. If the model is combined with a ruth nlu model
    ...
    def prepare_for_training(
        ...
        Args:
            domain: An instance of :class:`ruth.shared.core.domain.Domain`.
