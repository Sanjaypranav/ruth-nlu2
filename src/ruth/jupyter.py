...
from ruth.shared.utils.cli import print_error, print_success
import ruth.core.agent
...
def chat(
    ...
    if model_path:
        ...
        agent = ruth.core.agent.create_agent(model_path, endpoints)
    ...
    while True:
        ...
        responses = ruth.utils.common.run_in_loop(agent.handle_text(message))
