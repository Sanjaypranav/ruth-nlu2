...
from ruth.shared.constants import DEFAULT_MODELS_PATH, DEFAULT_RESULTS_PATH
...
from ruth.model import get_latest_model
...
def add_test_core_argument_group(
    ...
    parser.add_argument(
        ...
        "'ruth train core --config <config-1> <config-2>'. "
