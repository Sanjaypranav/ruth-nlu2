...
from ruth.cli.arguments import run as arguments
import ruth.cli.utils
import ruth.shared.utils.cli  # noqa: F401
...
def add_subparser(
    ...
    run_parser = subparsers.add_parser(
        ...
        help="Starts a ruth server with your trained model.",
    )
...
def run(args: argparse.Namespace) -> NoReturn:
    ...
    args.credentials = ruth.cli.utils.get_validated_path(
    ...
    try:
        ruth.model.get_local_model(args.model)
    ...
    ruth.shared.utils.cli.print_error(
        ...
        f"from.\n"
        f"3. Train a model before running the server using `ruth train` and "
