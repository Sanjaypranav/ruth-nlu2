...
import ruth.telemetry
import ruth.utils.io
import ruth.utils.tensorflow.environment as tf_env
from ruth import version
from ruth.cli import (
    data,
    export,
    interactive,
    run,
...
from ruth.cli.arguments.default_arguments import add_logging_options
from ruth.cli.utils import parse_last_positional_argument_as_model_path
from ruth.shared.exceptions import RasaException
from ruth.shared.utils.cli import print_error
from ruth.utils.common import set_log_and_warnings_filters, set_log_level
...
def create_argument_parser() -> argparse.ArgumentParser:
    ...
    parser = argparse.ArgumentParser(
        ...
        "your own conversational assistants 🤖. The 'ruth' command "
...
def print_version() -> None:
    """Prints version information of ruth tooling and python."""
...
def main() -> None:
    ...
    try:
        if hasattr(cmdline_arguments, "func"):
            ...
            ruth.telemetry.initialize_telemetry()
