...
from ruth.utils.tensorflow.temp_keras_modules import TmpKerasModel
from ruth.utils.tensorflow.data_generator import (
    RasaDataGenerator,
...
class RasaModel(TmpKerasModel):
    ...
    def run_inference(
        ...
        """
        outputs = {}
        (data_generator, _,) = ruth.utils.train_utils.create_data_generators(
