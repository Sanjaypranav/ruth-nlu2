...
from ruth.cli.utils import create_output_path
...
async def model_fingerprint(file_importer: "TrainingDataImporter") -> Fingerprint:
    ...
    return {
        ...
        FINGERPRINT_NLG_KEY: ruth.shared.utils.io.deep_container_fingerprint(responses),
        ...
        FINGERPRINT_RASA_VERSION_KEY: ruth.__version__,
    }
...
def _get_fingerprint_of_config(
    ...
    return ruth.shared.utils.io.deep_container_fingerprint(sub_config)
...
def _get_fingerprint_of_config_without_epochs(
    ...
    return ruth.shared.utils.io.deep_container_fingerprint(copied_config)
...
def fingerprint_from_path(model_path: Text) -> Fingerprint:
    ...
    if os.path.isfile(fingerprint_path):
        return ruth.shared.utils.io.read_json_file(fingerprint_path)
    else:
        return {}
...
def persist_fingerprint(output_path: Text, fingerprint: Fingerprint) -> None:
    ...
    ruth.shared.utils.io.dump_obj_as_json_to_file(path, fingerprint)
