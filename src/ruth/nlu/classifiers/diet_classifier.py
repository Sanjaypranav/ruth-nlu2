...
import ruth.nlu.utils.bilou_utils as bilou_utils
...
from ruth.nlu.classifiers import LABEL_RANKING_LENGTH
from ruth.utils import train_utils
...
class DIETClassifier(IntentClassifier, EntityExtractor):
    ...
    def __init__(
        ...
        if not self.model and self.finetune_mode:
            raise ruth.shared.exceptions.InvalidParameterException(
    ...
    def _create_model_data(
        ...
        from ruth.utils.tensorflow import model_data_utils
...
class DIET(TransformerRasaModel):
    ...
    def _update_metrics_to_log(self) -> None:
        debug_log_level = logging.getLogger("ruth").level == logging.DEBUG
