...
from ruth.nlu.constants import COMPONENT_INDEX
from ruth.shared.exceptions import RasaException
from ruth.shared.nlu.constants import TRAINABLE_EXTRACTORS
...
def validate_empty_pipeline(pipeline: List["Component"]) -> None:
    ...
    Args:
        pipeline: the list of the :class:`ruth.nlu.components.Component`.
    """
    if len(pipeline) == 0:
        raise InvalidConfigException(
...
def validate_only_one_tokenizer_is_used(pipeline: List["Component"]) -> None:
    ...
    from ruth.nlu.tokenizers.tokenizer import Tokenizer
...
def any_components_in_pipeline(
    ...
    Args:
        ...
        pipeline: A list of :class:`ruth.nlu.components.Component`s.
...
def validate_required_components_from_data(
    ...
    Args:
        pipeline: The list of the :class:`ruth.nlu.components.Component`s.
        data: The :class:`ruth.shared.nlu.training_data.training_data.TrainingData`.
    """
...
class Component(metaclass=ComponentMetaclass):
    ...
    def __init__(self, component_config: Optional[Dict[Text, Any]] = None) -> None:
        ...
        self.component_config: Dict[
            Text, Any
        ] = ruth.utils.train_utils.override_defaults(self.defaults, component_config)
    ...
    def load(
        ...
        **kwargs: Any,
        ...
        Args:
            ...
            model_metadata: The model's :class:`ruth.nlu.model.Metadata`.
    ...
    def train(
        ...
        **kwargs: Any,
        ...
        by a call to :meth:`ruth.nlu.components.Component.create`
        of ANY component and
        on any context attributes created by a call to
        :meth:`ruth.nlu.components.Component.train`
        of components previous to this one.

        Args:
            training_data: The
                :class:`ruth.shared.nlu.training_data.training_data.TrainingData`.
            config: The model configuration parameters.
        """
        pass
    ...
    def process(self, message: Message, **kwargs: Any) -> None:
        ...
        of ANY component and
        on any context attributes created by a call to
        :meth:`ruth.nlu.components.Component.process`
        of components previous to this one.

        Args:
            message: The :class:`ruth.shared.nlu.training_data.message.Message` to
                process.
        """
        pass
    ...
    def cache_key(
        ...
        Args:
            ...
            model_metadata: The component's :class:`ruth.nlu.model.Metadata`.
    ...
    def partially_process(self, message: Message) -> Message:
        ...
        Returns:
            The processed :class:`ruth.shared.nlu.training_data.message.Message`.
    ...
    def load_component(
        ...
        **context: Any,
        ...
        Args:
            ...
            model_metadata (Metadata):
                The model's :class:`ruth.nlu.model.Metadata`.
