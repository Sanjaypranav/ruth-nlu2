...
from ruth.nlu.featurizers.featurizer import SparseFeaturizer
...
from ruth.nlu.constants import TOKENS_NAMES, FEATURIZER_CLASS_ALIAS
from ruth.shared.nlu.constants import TEXT, FEATURE_TYPE_SEQUENCE
