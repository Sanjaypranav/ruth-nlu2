...
from ruth.shared.nlu.constants import TEXT, FEATURE_TYPE_SENTENCE, FEATURE_TYPE_SEQUENCE
from ruth.utils.tensorflow.constants import POOLING, MEAN_POOLING
