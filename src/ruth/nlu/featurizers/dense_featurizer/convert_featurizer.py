...
from ruth.exceptions import RasaException
import ruth.nlu.utils
import numpy as np
...
class ConveRTFeaturizer(DenseFeaturizer):
    ...
    def _get_validated_model_url(self) -> Text:
        ...
        if ruth.nlu.utils.is_url(model_url):
            return model_url
    ...
    def cache_key(
        ...
        return f"{cls.name}-{ruth.shared.utils.io.deep_container_fingerprint(_config)}"
