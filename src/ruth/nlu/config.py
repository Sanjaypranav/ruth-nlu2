...
def load(
    ...
    if config is not None:
        file_config = ruth.shared.utils.io.read_model_configuration(config)
...
def component_config_from_pipeline(
    ...
    try:
        ...
        return ruth.utils.train_utils.override_defaults(defaults, configuration)
    except IndexError:
        ...
        return ruth.utils.train_utils.override_defaults(
