...
from ruth.nlu.model import InvalidModelError
...
from ruth.nlu.constants import SPACY_DOCS, DENSE_FEATURIZABLE_ATTRIBUTES
...
class SpacyNLP(Component):
    ...
    def create(
        ...
        component_config = ruth.utils.train_utils.override_defaults(
