...
from ruth.nlu.constants import TOKENS_NAMES, SPACY_DOCS
from ruth.shared.nlu.constants import TEXT, INTENT, RESPONSE, ACTION_TEXT, ACTION_NAME
...
@pytest.mark.parametrize(
    ...
    [("am I the coolest person?", "no", True), ("ruth ruth", "sara sara", False),],
)
