...
from ruth.nlu.components import UnsupportedLanguageError
from ruth.nlu.config import RasaNLUModelConfig
from ruth.nlu.constants import TOKENS_NAMES
from ruth.shared.nlu.constants import TEXT, INTENT, ACTION_TEXT, ACTION_NAME
    ...
    [
        ...
        (
            ...
            [
                ...
                "client=safari&rls=en&q=i+like+ruth&ie=UTF-8&oe=UTF-8",
                "https://rasa.com/docs/rasa/components#whitespacetokenizer",
            ],
            [(0, 82), (83, 140)],
        ),
...
def test_whitespace_does_not_throw_error():
    texts = ruth.shared.utils.io.read_json_file(
