...
from ruth.shared.exceptions import InvalidConfigException, YamlSyntaxException
...
from ruth.nlu import config
import ruth.shared.nlu.training_data.loading
from ruth.nlu import components
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            ...
            "data/test/duplicate_intents_yaml/demo-ruth-intents-2.yml",
        ...
        (
            ...
            "data/test/demo-ruth-composite-entities.yml",
