...
from ruth.shared.core.events import SlotSet, UserUttered, ActionExecuted
from ruth.shared.core.training_data.structures import StoryStep, StoryGraph
from ruth.shared.importers.importer import (
...
from ruth.shared.nlu.constants import ACTION_TEXT, ACTION_NAME, INTENT, TEXT
from ruth.shared.nlu.training_data.message import Message
from ruth.shared.utils.validation import YamlValidationException
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            {
                "importers": [
                    {"name": "ruth.shared.importers.multi_project.MultiProjectImporter"}
                ]
            },
...
def test_importer_with_invalid_model_config(tmp_path: Path):
    ...
    ruth.shared.utils.io.write_yaml(invalid, config_file)
