...
import ruth.shared.core.training_data.loading
...
async def test_consistent_fingerprints():
    ...
    story_steps = await ruth.shared.core.training_data.loading.load_data_from_resource(
        stories_path, domain
    )
    ...
    # read again
    story_steps_2 = await (
        ruth.shared.core.training_data.loading.load_data_from_resource(
            stories_path, domain
        )
    )
