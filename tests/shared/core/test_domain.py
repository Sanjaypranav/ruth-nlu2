...
from ruth.shared.exceptions import YamlSyntaxException
...
from ruth.core import training, utils
from ruth.core.featurizers.tracker_featurizers import MaxHistoryTrackerFeaturizer
from ruth.shared.core.slots import InvalidSlotTypeException, TextSlot
...
from ruth.shared.core.events import ActionExecuted, SlotSet, UserUttered
...
def test_domain_fails_on_unknown_custom_slot_type(tmpdir, domain_unkown_slot_type):
    domain_path = str(tmpdir / "domain.yml")
    ruth.shared.utils.io.write_text_file(domain_unkown_slot_type, domain_path)
    ...
    assert domain_as_dict == {
        ...
        "slots": {
            "some_slot": {
                ...
                "type": "ruth.shared.core.slots.CategoricalSlot",
            }
        },
...
"""
    ...
    expected = ruth.shared.utils.io.read_yaml(test_yaml)
    actual = ruth.shared.utils.io.read_yaml(actual_yaml)
