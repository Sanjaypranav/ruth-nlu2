...
def test_docs_training_data(mdx_file_path: Path):
    ...
    for match in matches:
        ...
        for schema in schemas_to_try:
            try:
                ruth.shared.utils.validation.validate_yaml_schema(codeblock, schema)
