...
def _custom_default_config(
    ...
    config = ruth.shared.utils.io.read_yaml_file(default_config)
    ...
    ruth.shared.utils.io.write_yaml(config, config_for_test)
...
class TestNLULeakManyEpochs(MemoryLeakTest):
    ...
    def function_to_profile(self) -> None:
        import ruth.model_training

        with tempfile.TemporaryDirectory() as temp_dir:
            ruth.model_training.train_nlu(
    ...
    def name_for_dumped_files(self) -> Text:
        return (
            f"memory_usage_rasa_nlu_{ruth.__version__}_"
...
class TestCoreLeakManyEpochs(MemoryLeakTest):
    ...
    def function_to_profile(self) -> None:
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ruth.model_training.train_core(
    ...
    def name_for_dumped_files(self) -> Text:
        return (
            f"memory_usage_rasa_core_{ruth.__version__}_"
            f"epochs{self.epochs}_training_runs1"
        )
...
class TestCRFDenseFeaturesLeak(MemoryLeakTest):
    ...
    def function_to_profile(self) -> None:
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            ruth.shared.utils.io.write_yaml(config.as_dict(), config_for_test)
    ...
    @pytest.fixture()
    def name_for_dumped_files(self) -> Text:
        return f"memory_usage_rasa_nlu_crf_dense_{ruth.__version__}_"
