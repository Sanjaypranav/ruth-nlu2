...
import ruth.core.run
import ruth.core.channels.channel
from ruth.core import utils
from ruth.core.channels import RasaChatInput, console
from ruth.core.channels.channel import UserMessage
from ruth.core.channels.rasa_chat import (
    JWT_USERNAME_KEY,
    CONVERSATION_ID_KEY,
...
async def test_console_input():
    from ruth.core.channels import console
...
def test_facebook_channel():
    # START DOC INCLUDE
    from ruth.core.channels.facebook import FacebookInput
    ...
    s = ruth.core.run.configure_app([input_channel], port=5004)
    # END DOC INCLUDE
...
def test_webexteams_channel():
    # START DOC INCLUDE
    from ruth.core.channels.webexteams import WebexTeamsInput
...
def test_slack_channel():
    # START DOC INCLUDE
    from ruth.core.channels.slack import SlackInput
...
def test_mattermost_channel():
    # START DOC INCLUDE
    from ruth.core.channels.mattermost import MattermostInput
...
def test_botframework_channel():
    # START DOC INCLUDE
    from ruth.core.channels.botframework import BotFrameworkInput
...
def test_rocketchat_channel():
    # START DOC INCLUDE
    from ruth.core.channels.rocketchat import RocketChatInput
...
def test_telegram_channel():
    # START DOC INCLUDE
    from ruth.core.channels.telegram import TelegramInput
...
def test_telegram_channel_raise_rasa_exception_webhook_not_set():
    ...
    with pytest.raises(RasaException) as e:
        ruth.core.run.configure_app([input_channel], port=5004)
...
def test_twilio_channel():
    # START DOC INCLUDE
    from ruth.core.channels.twilio import TwilioInput
...
def test_callback_channel():
    # START DOC INCLUDE
    from ruth.core.channels.callback import CallbackInput
...
async def test_socketio_channel_jwt_authentication():
    ...
    assert ruth.core.channels.channel.decode_bearer_token(
...
async def test_socketio_channel_jwt_authentication_invalid_key(
    ...
    with caplog.at_level(logging.ERROR):
        ruth.core.channels.channel.decode_bearer_token(
...
async def test_callback_calls_endpoint():
    from ruth.core.channels.callback import CallbackOutput
...
def test_channel_inheritance():
    from ruth.core.channels import RestInput
    from ruth.core.channels.rasa_chat import RasaChatInput

    rasa_input = RasaChatInput("https://example.com")

    s = ruth.core.run.configure_app([RestInput(), rasa_input], port=5004)
...
async def test_send_elements_without_buttons():
    from ruth.core.channels.channel import OutputChannel
...
def test_register_channel_without_route():
    ...
    app = Sanic(__name__)
    ruth.core.channels.channel.register([input_channel], app, route=None)
...
def test_channel_registration_with_absolute_url_prefix_overwrites_route():
    ...
    ruth.core.channels.channel.register(
...
async def test_rasa_chat_input():
    from ruth.core.channels import RasaChatInput
