...
from ruth.core.channels import CollectingOutputChannel, OutputChannel
from ruth.core.nlg import NaturalLanguageGenerator
from ruth.shared.constants import UTTER_PREFIX
from ruth.shared.core.domain import (
...
from ruth.core.nlg.response import TemplatedNaturalLanguageGenerator
...
from ruth.utils.endpoints import ClientResponseError, EndpointConfig
...
async def test_remote_action_logs_events(
    ...
    response = {
        "events": [{"event": "slot", "value": "ruth", "name": "name"}],
        "responses": [
            {
                "text": "test text",
                "response": None,
    ...
    assert events[2] == SlotSet("name", "ruth")
