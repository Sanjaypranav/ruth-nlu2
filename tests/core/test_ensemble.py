...
from ruth.shared.core.events import UserUttered, ActiveLoop, Event, SlotSet
...
from ruth.core.policies.ensemble import (
    PolicyEnsemble,
    InvalidPolicyConfig,
...
from ruth.core.constants import FORM_POLICY_PRIORITY
from ruth.shared.core.events import ActionExecuted, DefinePrevUserUtteredFeaturization
...
from ruth.core.policies.unexpected_intent_policy import UnexpecTEDIntentPolicy
...
def test_fallback_mapping_restart():
    ...
    next_action = ruth.core.actions.action.action_for_index(
