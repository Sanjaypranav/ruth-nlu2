...
from ruth.core.actions.action import ActionExecutionRejection
from ruth.shared.constants import REQUIRED_SLOTS_KEY, IGNORED_INTENTS
from ruth.shared.core.constants import ACTION_LISTEN_NAME, REQUESTED_SLOT
...
"""
    ...
    # Driving it like ruth/core/processor
    ...
    # ruth/core/processor.predict_next_action
