...
from ruth.core.actions.action import (
    ActionBotResponse,
    ActionListen,
    ActionExecutionRejection,
    ActionUnlikelyIntent,
)
import ruth.core.policies.policy
from ruth.core.nlg import NaturalLanguageGenerator, TemplatedNaturalLanguageGenerator
...
from ruth.shared.core.domain import SessionConfig, Domain, KEY_ACTIONS
...
from ruth.core.interpreter import RasaNLUHttpInterpreter
from ruth.shared.nlu.interpreter import NaturalLanguageInterpreter, RegexInterpreter
from ruth.core.policies import SimplePolicyEnsemble, PolicyEnsemble
from ruth.core.policies.ted_policy import TEDPolicy
from ruth.core.policies.memoization import MemoizationPolicy
...
from ruth.core.lock_store import InMemoryLockStore
...
def test_predict_next_action_with_deprecated_ensemble(
    ...
    expected_probabilities = ruth.core.policies.policy.confidence_scores_for(
