...
from ruth.constants import RESULTS_FILE
from ruth.shared.constants import DEFAULT_RESULTS_PATH
from ruth.shared.utils.io import list_files, write_yaml, write_text_file
...
def test_test_help(run: Callable[..., RunResult]):
    ...
    help_text = """usage: ruth test [-h] [-v] [-vv] [--quiet] [-m MODEL] [-s STORIES]
...
def test_test_nlu_help(run: Callable[..., RunResult]):
    ...
    help_text = """usage: ruth test nlu [-h] [-v] [-vv] [--quiet] [-m MODEL] [-u NLU] [--out OUT]
                     [-c CONFIG [CONFIG ...]] [--cross-validation] [-f FOLDS]
                     [-r RUNS] [-p PERCENTAGES [PERCENTAGES ...]] [--no-plot]
...
def test_test_core_help(run: Callable[..., RunResult]):
    ...
    help_text = """usage: ruth test core [-h] [-v] [-vv] [--quiet] [-m MODEL [MODEL ...]]
